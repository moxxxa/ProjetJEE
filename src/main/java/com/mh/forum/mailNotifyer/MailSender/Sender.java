package com.mh.forum.mailNotifyer.MailSender;
...
import java.util.logging.Logger;
    ...
    public class Sender {
        ...
        public void sendMail(String emailTo, String message, String subject) throws MessagingException {
            ...
            final String emailBodyF = "<font face=\"arial\">Hello there !<br>" +
                    message +
                    "<br>Should you have any question regarding this mail, thank you to contact <a href = \"mailto: msouissi2@myges.fr\">" +
                    ".<br>Best regards,<br><br><strong>Ideas Matter team</strong></font>";
